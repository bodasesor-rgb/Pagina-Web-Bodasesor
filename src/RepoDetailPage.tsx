...
export default function RepoDetailPage({ slug }: { slug?: string }) {
  ...
  const waMsg = WA_BASE + encodeURIComponent(`Hola, me interesa cotizar "${product.name}" para mi evento. ¿Me pueden dar información?`);
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-[#f5efe8] border-b border-[#162040]/10 py-3 px-4">
        <div className="max-w-7xl mx-auto flex items-center gap-2 font-serif text-xs text-[#162040]/50">
          ...
          <span>/</span>
          <Link href="/reposteria" className="hover:text-[#162040]">Repostería</Link>
          <span>/</span>
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid lg:grid-cols-2 gap-12 mb-16">
          ...
          {/* Info */}
          <div>
            <p className="text-[10px] font-serif font-bold uppercase tracking-widest text-[#162040]/40 mb-2">Repostería Artesanal</p>
        ...
        {others.length > 0 && (
          <div>
            <h2 className="text-2xl font-serif font-bold text-[#162040] mb-6">Otras especialidades</h2>
