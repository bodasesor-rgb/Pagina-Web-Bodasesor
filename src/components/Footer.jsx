...
export default function Footer() {
  return (
    <footer className="bg-[#162040] text-gray-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <p className="mt-4 text-sm text-[#8a9bb5] leading-relaxed">
            Banquetes premium, catering gourmet y mobiliario elegante para eventos en todo México.
          </p>
          <div className="flex gap-3 mt-5">
            <a href={INSTAGRAM_URL} target="_blank" rel="noopener noreferrer"
              className="w-9 h-9 rounded-full bg-[#1d2b52] hover:bg-primary flex items-center justify-center transition-colors">
            ...
            <a href={whatsappLink()} target="_blank" rel="noopener noreferrer"
              className="w-9 h-9 rounded-full bg-[#1d2b52] hover:bg-green-500 flex items-center justify-center transition-colors">
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="border-t border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-5 text-center text-xs text-[#8a9bb5]">
