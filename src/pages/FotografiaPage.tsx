...
export default function FotografiaPage() {
  const { city, cityCopy, displayH1, displayHeadline, displaySectionTitle, keywords } =
    useCityHubPage(
      "fotografia",
      PRIORITY_HUB_SERP.fotografia.h1,
      ["video y fotografía", "fotografía para eventos", "video para eventos"],
      hubPageSeo("fotografia"),
    );
  return (
    <div className="min-h-screen bg-white">
          ...
          <div>
            ...
            <p className="text-white/70 font-serif text-lg mb-4">
              {displayHeadline ? (
                ...
                "Fotógrafo, cámara 360°, cabinas de fotos, Magic Mirror, Vogue, pantalla verde, Hollywood Photo Booth y producción de video."
              )}
            </p>
      ...
      <CityHubSeoSections
        ...
        fallback={
          <p>
            Servicios de <strong>fotografía y video para eventos</strong>
            {city ? (
              <>
            ...
            : fotógrafo, cabinas, cámara 360° y producción audiovisual.
          </p>
        }
      />
