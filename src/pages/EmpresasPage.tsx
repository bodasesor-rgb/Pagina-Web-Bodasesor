    ...
    <div className="group bg-white rounded-2xl overflow-hidden border border-[#162040]/8 hover:border-[#162040]/25 hover:shadow-xl transition-all duration-300">
      <Link href={`/alimentos-empresas/${product.slug}`}>
        <div className="h-44 overflow-hidden bg-[#f5efe8]">
          {product.img ? <img src={product.img} alt={product.name} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" /> : <div className="w-full h-full flex items-center justify-center"><PlaceholderIcon symbol="◎" className="w-12 h-12 text-[#162040]/20" /></div>}
        </div>
      </Link>
      <div className="p-4">
