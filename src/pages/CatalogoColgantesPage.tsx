    ...
    <div className="min-h-screen bg-[#f5efe8]">
      ...
      <div className="bg-[#162040] px-4 py-3 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <a href="/catalogos/colgantes.pdf" download
      ...
      {/* PDF embed */}
      <div className="w-full" style={{ height: 'calc(100vh - 52px)' }}>
        <iframe
          src="/catalogos/colgantes.pdf"
          className="w-full h-full border-0"
          title="Catálogo Colgantes Premium 2026 — Bodasesor"
        />
      </div>
