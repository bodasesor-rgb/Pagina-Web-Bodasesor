          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-3">
            {CATEGORIES.map(cat => (
              <a key={cat.key} href={`#${cat.key}`}
                ...
                <span className="text-[10px] font-serif text-gray-400 mt-0.5">{cat.desc}</span>
              </a>
            ))}
          </div>
        </div>
          ...
          <section key={cat.key} id={cat.key} className="py-12 px-4 border-t border-gray-100 scroll-mt-20">
            <div className="max-w-7xl mx-auto">
              <div className="flex items-end justify-between mb-8">
                <div>
                  <p className="text-[10px] font-serif font-bold uppercase tracking-widest text-[#162040]/40 mb-1">Categoría</p>
