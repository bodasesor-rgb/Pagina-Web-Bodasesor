    ...
    <div className="min-h-screen bg-white">
      <div className="bg-[#f5efe8] border-b border-[#162040]/10 py-3 px-4">
        <div className="max-w-7xl mx-auto flex items-center gap-2 font-serif text-xs text-[#162040]/50">
          ...
          <Link href="/fotografia" className="hover:text-[#162040]">Fotografía y Video</Link><span>/</span>
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid lg:grid-cols-2 gap-12 mb-16">
          ...
          <div>
            <p className="text-[10px] font-serif font-bold uppercase tracking-widest text-[#162040]/40 mb-2">Fotografía y Video</p>
        ...
        {others.length > 0 && (
          <div>
            <h2 className="text-2xl font-serif font-bold text-[#162040] mb-6">Otros servicios de fotografía y video</h2>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              {others.map(p => (
                <Link key={p.slug} href={`/fotografia/${p.slug}`} className="group bg-white rounded-2xl overflow-hidden border border-[#162040]/8 hover:border-[#162040]/25 hover:shadow-lg transition-all">
