          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            {CATEGORIES.map(cat => (
              <a key={cat.id} href={`#${cat.id}`}
                ...
                <p className="font-serif text-xs text-gray-500 mb-2 hidden sm:block line-clamp-2">{cat.desc}</p>
                <p className="font-serif text-xs text-[#162040]/50 font-semibold">{cat.items.length} servicios →</p>
              </a>
            ))}
          </div>
        </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex items-center gap-3 mb-8">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 font-serif">{cat.desc}</p>
              </div>
            </div>
  ...
  return (
    <div className="group bg-white rounded-2xl overflow-hidden border border-[#162040]/8 hover:border-[#162040]/25 hover:shadow-xl transition-all duration-300">
      ...
      <div className="p-4">
        ...
        <p className="font-serif text-gray-500 text-xs mb-4 leading-relaxed line-clamp-2">{tag}</p>
