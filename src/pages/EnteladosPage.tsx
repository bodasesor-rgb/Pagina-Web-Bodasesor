    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-12 px-4 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-[10px] font-serif font-bold uppercase tracking-widest text-[#162040]/75 mb-2">¿Qué es?</p>
      ...
      <section className="py-12 px-4 border-t border-gray-100">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-10">
            <p className="text-[10px] font-serif font-bold uppercase tracking-widest text-[#162040]/75 mb-2">Catálogo</p>
            ...
            {ENTELADOS.map(estilo => (
              <div key={estilo.slug}
                ...
                <div className="p-5">
                  ...
                  <p className="font-serif text-gray-600 text-xs mb-3 leading-relaxed">{estilo.tagline}</p>
                  <p className="font-serif text-gray-600 text-xs mb-4 leading-relaxed line-clamp-3">{estilo.short}</p>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-2xl p-8 flex flex-col sm:flex-row items-center gap-6 border border-[#162040]/8">
            ...
            <div>
              ...
              <a href={waGeneral} target="_blank" rel="noopener noreferrer"
                className="inline-flex items-center gap-2 text-sm font-serif font-semibold text-[#0d6849] hover:underline">
      ...
      <section className="py-12 px-4 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-[10px] font-serif font-bold uppercase tracking-widest text-[#162040]/75 mb-2">Simple y transparente</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            {[
              ...
              <div key={step.n} className="bg-[#f5efe8] rounded-2xl p-6 text-left">
                ...
                <p className="font-serif text-gray-600 text-sm">{step.desc}</p>
              </div>
            ))}
          </div>
        </div>
