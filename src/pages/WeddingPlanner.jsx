    ...
    <>
      <section className="pt-32 pb-16 px-4 bg-gray-900 text-white text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-amber-400 text-sm font-semibold uppercase tracking-widest mb-3">Bodasesor Eventos</p>
          ...
          <p className="text-amber-400 text-sm mb-8">6 servicios disponibles · Desde asesoría puntual hasta la creación total de tu evento.</p>
          <div className="flex flex-wrap gap-4 justify-center">
            <a href={whatsappLink('Hola, me interesa el servicio de Wedding Planner')}
              target="_blank" rel="noopener noreferrer"
              className="bg-amber-500 hover:bg-amber-600 text-white font-semibold px-8 py-4 rounded-full transition-colors">
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            <p className="text-amber-600 text-sm font-semibold uppercase tracking-widest mb-2">Servicios</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {WEDDING_PLANNER_SERVICES.map((s, i) => (
              <div key={i} className="border border-gray-100 rounded-2xl p-7 hover:shadow-md hover:border-amber-200 transition-all">
                <h3 className="font-serif text-xl text-gray-900 mb-1">{s.name}</h3>
                <p className="text-amber-600 text-sm font-medium mb-3">{s.desc}</p>
      ...
      <section className="py-16 px-4 bg-amber-50 text-center">
