...
export default function EspaciosDetailPage({ slug }: { slug?: string }) {
  ...
  usePageSeo({
    ...
    path: product ? `/espacios-eventos/${product.slug}` : undefined,
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid lg:grid-cols-2 gap-12 mb-16">
          ...
          <div>
            <p className="text-[10px] font-serif font-bold uppercase tracking-widest text-[#162040]/75 mb-2">Espacios para Eventos</p>
