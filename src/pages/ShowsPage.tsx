  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section id="percusion" className="py-12 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-3 mb-8">
            <Drum className="w-7 h-7 text-[#162040]/75" />
            <div>
      ...
      <section id="danza" className="py-12 px-4 bg-[#f5efe8]">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-3 mb-8">
            <Sparkles className="w-7 h-7 text-[#162040]/75" />
            <div>
              <p className="text-[10px] font-serif font-bold uppercase tracking-widest text-[#162040]/75">Categoría</p>
      ...
      <section id="tecnologia" className="py-12 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-3 mb-8">
            <Zap className="w-7 h-7 text-[#162040]/75" />
            <div>
              <p className="text-[10px] font-serif font-bold uppercase tracking-widest text-[#162040]/75">Categoría</p>
      ...
      <section id="circo" className="py-12 px-4 bg-[#f5efe8]">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-3 mb-8">
            <CircleDot className="w-7 h-7 text-[#162040]/75" />
            <div>
              <p className="text-[10px] font-serif font-bold uppercase tracking-widest text-[#162040]/75">Categoría</p>
