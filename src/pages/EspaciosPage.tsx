      ...
      <section className="bg-[#162040] text-white">
        <div className="max-w-7xl mx-auto px-4 py-16 lg:py-24 grid lg:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <p className="text-white/50 font-serif text-sm mb-8">{ESPACIOS.length} tipos de venue disponibles. Cada espacio pensado para que tu celebración sea exactamente como la imaginaste.</p>
      ...
      <section className="py-14 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-3 mb-10">
            ...
            <div>
              <p className="text-[10px] font-serif font-bold uppercase tracking-widest text-[#162040]/40">Catálogo de Venues</p>
  ...
  return (
    <div className="group bg-white rounded-2xl overflow-hidden border border-[#162040]/8 hover:border-[#162040]/25 hover:shadow-xl transition-all duration-300">
      ...
      <div className="p-6">
        ...
        <p className="font-serif text-gray-500 text-sm mb-3 italic">{product.tagline}</p>
        <p className="font-serif text-gray-400 text-sm mb-5 leading-relaxed">{product.short}</p>
        <div className="flex gap-3">
          ...
          <a href={waMsg} target="_blank" rel="noopener noreferrer" className="flex-1 text-center text-sm font-serif font-semibold text-white bg-[#25D366] hover:bg-green-500 py-2.5 rounded-xl transition-colors">Consultar</a>
        </div>
      </div>
    </div>
  );
