...
import { BANQUETE_COMIDA_PHOTOS } from "../data/product-galleries";
...
const BANQUETE_COMIDA_GALLERY = BANQUETE_COMIDA_PHOTOS.map((src, i) => ({
  src,
  alt: `Banquete y catering Bodasesor — platillo ${i + 1} | Bodasesor`,
}))

const INSTAGRAM_PHOTOS = Array.from({ length: 281 }, (_, i) => i + 1)
...
const ALL_PHOTOS = [...BANQUETE_COMIDA_GALLERY, ...INSTAGRAM_PHOTOS]
...
export default function GaleriaPage() {
  ...
  usePageSeo({
    ...
    description: `Más de ${TOTAL_PHOTOS} fotos reales de bodas, catering, XV años y eventos corporativos producidos por Bodasesor en México.`,
    path: "/galeria",
    h1: "Galería de Banquetes y Eventos Reales",
    image: "/images/galeria/g1.jpg",
  });
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-wrap items-center justify-between gap-4">
            ...
            <a
              ...
              className="flex items-center gap-2 bg-[#0d6849] hover:bg-[#0a5740] text-white px-5 py-2.5 rounded-xl font-bold font-serif text-sm transition-all duration-300 hover:scale-105"
            >
