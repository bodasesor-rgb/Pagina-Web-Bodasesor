...
export default function WeddingDetailPage({ slug }: { slug?: string }) {
  const { city } = useCity();
  const product = WEDDING.find(p => p.slug === slug);
  ...
  const others = WEDDING.filter(p => p.slug !== slug).slice(0, 3);
    ...
    <div className="min-h-screen bg-white">
      <div className="bg-[#f5efe8] border-b border-[#162040]/10 py-3 px-4">
        <div className="max-w-7xl mx-auto flex items-center gap-2 font-serif text-xs text-[#162040]/50">
          ...
          <Link href="/wedding-planner" className="hover:text-[#162040]">Wedding Planner</Link><span>/</span>
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid lg:grid-cols-2 gap-12 mb-16">
          ...
          <div>
            <p className="text-[10px] font-serif font-bold uppercase tracking-widest text-[#162040]/40 mb-2">Wedding Planner</p>
