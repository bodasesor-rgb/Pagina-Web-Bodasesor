      ...
      <section className="py-16 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-10">
            <p className="text-[10px] font-serif font-bold uppercase tracking-widest text-[#162040]/40 mb-2">Nuestro catálogo</p>
            <h2 className="text-3xl font-serif font-bold text-[#162040]">
              Elige tu mesa ideal
            </h2>
            <p className="text-gray-500 font-serif mt-2 max-w-xl mx-auto">
