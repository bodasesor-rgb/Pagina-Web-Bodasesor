    ...
    <div className="group bg-white rounded-2xl overflow-hidden border border-[#162040]/8 hover:border-[#162040]/25 hover:shadow-xl transition-all duration-300">
      ...
      <div className="p-5">
        ...
        <div className="flex gap-2">
          ...
          <a href={waMsg} target="_blank" rel="noopener noreferrer" className="flex-1 text-center text-xs font-serif font-semibold text-white bg-[#0d6849] hover:bg-[#0a5740] py-2 rounded-lg transition-colors">Consultar</a>
        </div>
      </div>
    </div>
  );
