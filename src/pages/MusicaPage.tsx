      ...
      <section className="py-14 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-3 mb-10">
            ...
            <div>
              <p className="text-[10px] font-serif font-bold uppercase tracking-widest text-[#162040]/75">Catálogo Musical</p>
    ...
    <div className="group bg-white rounded-2xl overflow-hidden border border-[#162040]/8 hover:border-[#162040]/25 hover:shadow-xl transition-all duration-300">
      <Link href={`/musica/${product.slug}`}>
        <div className="h-48 overflow-hidden bg-[#f5efe8]">
          {product.img ? <CatalogImage src={product.img} alt={product.name} width={400} height={192} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" /> : <div className="w-full h-full flex items-center justify-center text-[#162040]/20 font-serif text-5xl">♪</div>}
        </div>
      </Link>
      <div className="p-5">
