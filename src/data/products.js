// Products extracted from bodasesor.com — 94 products with full data
const PRODUCTS = [
  {
    "slug": "banquetes",
    ...
    "included": [
      {
        "icon": "👨‍🍳",
        "text": "Supervisión de un chef ejecutivo certificado durante toda la preparación y servicio."
      },
      {
        "icon": "🍽️",
        "text": "Personal uniformado y capacitado: un mesero por cada 10 comensales."
      },
      {
        "icon": "🥂",
        "text": "Copas de cristal, vajilla fina y cubiertos de acero inoxidable premium."
      },
      {
        "icon": "🌹",
        "text": "Arreglo floral básico incluido en cada mesa de invitados."
      },
      {
        "icon": "🎂",
        "text": "Pastel personalizado de hasta 3 pisos incluido en paquetes completos."
      },
      {
        "icon": "📋",
        "text": "Un coordinador de banquete dedicado para la organización del día."
      }
    ],
    "whyUs": [],
    "varieties": [],
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "✡️",
        "text": "Supervisión de un mashguiaj (supervisor rabínico) durante toda la preparación."
      },
      {
        "icon": "🧂",
        "text": "Todos los insumos cuentan con sello Kosher de organismos reconocidos."
      },
      {
        "icon": "🍽️",
        "text": "Uso de vajilla exclusiva para cárnicos y lácteos, nunca mezclados."
      },
      {
        "icon": "👨‍🍳",
        "text": "Chef con formación en cocina Kosher y amplia experiencia en comunidades judías."
      },
      {
        "icon": "📋",
        "text": "El menú completo es revisado y aprobado por el supervisor rabínico antes del evento."
      },
      {
        "icon": "🚚",
        "text": "Traslado de alimentos en vehículos refrigerados y embalaje Kosher certificado."
      }
    ],
    "whyUs": [],
    "varieties": [],
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "🌶️",
        "text": "Platillos auténticos de diferentes estados: Oaxaca, Puebla, Veracruz, Yucatán y más."
      },
      {
        "icon": "🌽",
        "text": "Chiles secos, especias, hierbas y productos del campo mexicano de primera calidad."
      },
      {
        "icon": "🍽️",
        "text": "Personal uniformado con trajes típicos opcionales para ambientar el evento."
      },
      {
        "icon": "🫙",
        "text": "Hasta 5 tipos de salsas caseras preparadas el mismo día del evento."
      },
      {
        "icon": "🌮",
        "text": "Tortillera en sitio para servir tortillas frescas durante toda la cena."
      },
      {
        "icon": "🍹",
        "text": "Bebidas tradicionales incluidas sin costo adicional."
      }
    ],
    "whyUs": [],
    "varieties": [],
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "🦃",
        "text": "Elige entre pavo relleno al horno o bacalao a la vizcaína como plato estrella."
      },
      {
        "icon": "🎄",
        "text": "Centros de mesa temáticos y arreglos navideños incluidos en el montaje."
      },
      {
        "icon": "🍷",
        "text": "Sidra o ponche de frutas para el brindis de inicio de la cena."
      },
      {
        "icon": "🍽️",
        "text": "Meseros uniformados y coordinador de servicio durante toda la cena."
      },
      {
        "icon": "🎊",
        "text": "Detalle de Navidad para cada invitado: chocolates, turrones o almendras garapiñadas."
      },
      {
        "icon": "🎵",
        "text": "Playlist navideña curada o mariachi opcional para ambientar la velada."
      }
    ],
    "whyUs": [],
    "varieties": [],
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "🍲",
        "text": "Preparado en olla de barro o acero inoxidable de gran capacidad, servido caliente."
      },
      {
        "icon": "🌽",
        "text": "Usamos exclusivamente maíz cacahuazintle de la mejor calidad, cosido al punto exacto."
      },
      {
        "icon": "🥬",
        "text": "Lechuga, orégano, cebolla, chile, tostadas, limón, rábanos y chicharrón."
      },
      {
        "icon": "🫙",
        "text": "Salsa roja, verde y habanero preparadas en el momento para los más atrevidos."
      },
      {
        "icon": "🍽️",
        "text": "Tostadas de tinga, pata, frijoles, pollo y aguacate servidas en canastas."
      },
      {
        "icon": "👨‍🍳",
        "text": "Cocinero y mesero(s) según el número de comensales. Uniformados y capacitados."
      }
    ],
    "whyUs": [],
    "varieties": [],
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "🥘",
        "text": "Preparación completa frente a tus invitados. El proceso es parte del espectáculo."
      },
      {
        "icon": "🦐",
        "text": "Camarones, mejillones, almejas y calamar. Todo seleccionado el día del evento."
      },
      {
        "icon": "🧡",
        "text": "Usamos azafrán de hebra importado de España para el color y sabor genuino."
      },
      {
        "icon": "🍋",
        "text": "Servida con alioli artesanal y gajos de limón. La combinación perfecta."
      },
      {
        "icon": "🍽️",
        "text": "Personal para servir en platos o en formato de estación self-service."
      },
      {
        "icon": "🫓",
        "text": "Pan rústico para acompañar el caldo y los jugos de la paella."
      }
    ],
    "whyUs": [],
    "varieties": [],
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "🥣",
        "text": "Sopas de pasta, cremas de verduras o consommé según el menú del día."
      },
      {
        "icon": "🥗",
        "text": "Proteína (pollo, res, cerdo o pescado) con guarnición de verduras y/o arroz."
      },
      {
        "icon": "🍚",
        "text": "Siempre incluidos como guarnición. Recetas caseras sin conservadores."
      },
      {
        "icon": "🍹",
        "text": "Jamaica, limón, pepino u otra agua de sabor natural preparada en el lugar."
      },
      {
        "icon": "🥖",
        "text": "Tortillas calientes o pan de mesa para acompañar el guisado."
      },
      {
        "icon": "🍮",
        "text": "Fruta de temporada, gelatina, flan o arroz con leche para cerrar."
      }
    ],
    "whyUs": [],
    "varieties": [],
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "☕",
        "text": "Café de origen seleccionado, preparado en máquina espresso profesional."
      },
      {
        "icon": "🫖",
        "text": "Mínimo 4 tipos de té: negro, verde, menta y frutos rojos."
      },
      {
        "icon": "🥐",
        "text": "Croissants, muffins, scones, pan dulce y galletas hechos el mismo día."
      },
      {
        "icon": "🥪",
        "text": "Opción salada: sándwiches miniatura surtidos con variedad de rellenos."
      },
      {
        "icon": "🍓",
        "text": "Fruta cortada de temporada en presentación elegante con dips opcionales."
      },
      {
        "icon": "🧃",
        "text": "Jugo de naranja exprimido y agua infusionada con pepino y menta."
      }
    ],
    "whyUs": [],
    "varieties": [],
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "🫙",
        "text": "Mínimo 8 tipos de bocadillos diferentes, equilibrando opciones dulces y saladas."
      },
      {
        "icon": "🍽️",
        "text": "Meseros uniformados circulando con charolas elegantes entre los invitados."
      },
      {
        "icon": "🌿",
        "text": "Al menos 3 opciones 100% vegetarianas incluidas en todos los paquetes."
      },
      {
        "icon": "❄️",
        "text": "Los bocadillos fríos y calientes llegan en temperatura ideal gracias a nuestro equipo."
      },
      {
        "icon": "🍽️",
        "text": "Servidos en cucharas de cerámica, mini platos de pizarra o charolas plateadas."
      },
      {
        "icon": "🥂",
        "text": "Recomendación de vinos, cócteles o maridajes que complementen cada bocadillo."
      }
    ],
    "whyUs": [],
    "varieties": [],
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "👑",
        "text": "Caviar, trufa, foie gras, langosta, jamón ibérico y quesos de importación."
      },
      {
        "icon": "🤵",
        "text": "Meseros de guante blanco con descripción verbal de cada pieza."
      },
      {
        "icon": "🎨",
        "text": "Cada canapé es un mini cuadro: colores, texturas y alturas perfectamente balanceadas."
      },
      {
        "icon": "❄️",
        "text": "Transporte en cajas isotérmicas y servicio en tiempo perfecto para cada pieza."
      },
      {
        "icon": "🍾",
        "text": "Recomendación y coordinación con el sommelier para el maridaje correcto."
      },
      {
        "icon": "📝",
        "text": "Tarjetas de menú personalizadas con descripción de cada canapé para los invitados."
      }
    ],
    "whyUs": [],
    "varieties": [],
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "🥚",
        "text": "Huevos al gusto: revueltos, estrellados, benedictinos y en salsa. Cocinados al momento."
      },
      {
        "icon": "☕",
        "text": "Café americano, espresso, té, atole y chocolate caliente. Todo incluido."
      },
      {
        "icon": "🥞",
        "text": "Con mantequilla, miel de abeja, cajeta, fresas y crema batida."
      },
      {
        "icon": "🍊",
        "text": "Exprimido al momento en estación visible para los invitados."
      },
      {
        "icon": "🥐",
        "text": "Surtido de bollería, conchas, cuernos, croissants y pan tostado."
      },
      {
        "icon": "🍓",
        "text": "Fruta fresca cortada en el lugar, presentada en charolas o vasitos."
      }
    ],
    "whyUs": [],
    "varieties": [],
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "🥞",
        "text": "Cada crepa preparada frente a los invitados en plancha profesional. Masa fresca del día."
      },
      {
        "icon": "🍫",
        "text": "Opciones dulces y saladas clásicas, gourmet y especiales para todos los gustos."
      },
      {
        "icon": "🧀",
        "text": "Nutella, cajeta, S'mores, Selva negra + jamón y queso, pollo al chipotle, tres quesos."
      },
      {
        "icon": "🍓",
        "text": "Fresas frescas, crema batida, helado de vainilla, frutos secos y mermeladas artesanales."
      },
      {
        "icon": "👨‍🍳",
        "text": "Crepero capacitado que prepara cada crepa con precisión y rapidez para todos los invitados."
      },
      {
        "icon": "✨",
        "text": "Mesa estilizada con iluminación, letreros y decoración que armoniza con tu evento."
      }
    ],
    "whyUs": [],
    "varieties": [],
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "🍣",
        "text": "Especialista con formación en técnica nipona y experiencia en eventos de alto nivel."
      },
      {
        "icon": "🐟",
        "text": "Salmón noruego, atún aleta amarilla y anguila de la más alta calidad."
      },
      {
        "icon": "🍚",
        "text": "Arroz japonés koshihikari adobado con vinagre de arroz, azúcar y sal."
      },
      {
        "icon": "🥑",
        "text": "Edamame, mango, aguacate, pepino, masago, teriyaki y mucho más."
      },
      {
        "icon": "🫙",
        "text": "Soya, sriracha, mayo spicy, teriyaki, ponzu y eel sauce preparadas en sitio."
      },
      {
        "icon": "🧊",
        "text": "Display en hielo seco con iluminación para resaltar la frescura del producto."
      }
    ],
    "whyUs": [],
    "varieties": [],
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "🦐",
        "text": "Camarón jumbo y U15 del Pacífico, cocido y frío, para cocteles y tostadas."
      },
      {
        "icon": "🦪",
        "text": "Ostiones al natural o preparados, servidos en hielo con mignonette y limón."
      },
      {
        "icon": "🐟",
        "text": "Ceviche de mero, camarón o pulpo preparado al momento con limón verde."
      },
      {
        "icon": "🌶️",
        "text": "El clásico sinaloense: camarón en jugo de limón, chile y verdura fresca."
      },
      {
        "icon": "🫙",
        "text": "Clamato casero, valentina, salsa macha, habanero tatemado y más."
      },
      {
        "icon": "🍋",
        "text": "Tostadas de maíz artesanales y totopos recién hechos para los ceviches."
      }
    ],
    "whyUs": [],
    "varieties": [],
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "🥖",
        "text": "Horneado en el día, con corteza crujiente y miga aireada. También disponible integral."
      },
      {
        "icon": "🧀",
        "text": "Mozzarella italiana, manchego español, brie francés y cheddar inglés."
      },
      {
        "icon": "🥩",
        "text": "Jamón serrano, salami genovés, pechuga de pavo premium y roast beef."
      },
      {
        "icon": "🫒",
        "text": "Pimientos, calabaza, berenjena y cebolla asados en oliva extra virgen."
      },
      {
        "icon": "🔥",
        "text": "Plancha de hierro fundido para el prensado perfecto en el momento."
      },
      {
        "icon": "🥗",
        "text": "Mini ensalada verde o pasta fría incluida como guarnición."
      }
    ],
    "whyUs": [],
    "varieties": [],
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "🍝",
        "text": "Spaghetti, penne, fettuccine y rigatoni disponibles simultáneamente."
      },
      {
        "icon": "🍅",
        "text": "Boloñesa, alfredo, al pesto, arrabiata, carbonara y pomodoro fresco."
      },
      {
        "icon": "🫒",
        "text": "AOVE italiano de primera presión en frío para terminar cada plato."
      },
      {
        "icon": "🧀",
        "text": "Queso parmesano auténtico rallado en el momento sobre cada plato."
      },
      {
        "icon": "🥗",
        "text": "Verde, caprese y pasta fría disponibles como opción ligera."
      },
      {
        "icon": "🍞",
        "text": "Pan baguette con mantequilla de ajo al horno, servido caliente."
      }
    ],
    "whyUs": [],
    "varieties": [],
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "🍕",
        "text": "Pizzero profesional que estira, prepara y hornea cada pizza frente a tus invitados."
      },
      {
        "icon": "🔥",
        "text": "Horno de leña o gas de alta temperatura para cocción perfecta en 90 segundos."
      },
      {
        "icon": "🌾",
        "text": "72 horas de fermentación con harina tipo 00 de Nápoles. El secreto está en la masa."
      },
      {
        "icon": "🍅",
        "text": "Jitomate San Marzano DOP importado de Italia. Sin espesantes ni aditivos."
      },
      {
        "icon": "🧀",
        "text": "Mozzarella fresca producida en México bajo estándares italianos."
      },
      {
        "icon": "🫒",
        "text": "Terminado con AOVE siciliano, albahaca fresca y chile al gusto."
      }
    ],
    "whyUs": [],
    "varieties": [],
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "🍔",
        "text": "Sliders de res artesanal en pan brioche con queso, lechuga, jitomate y pepinillos."
      },
      {
        "icon": "🍗",
        "text": "Alitas y boneless con salsas BBQ, búfalo, honey-garlic y ranch dip."
      },
      {
        "icon": "🍟",
        "text": "Nachos con queso cheddar fundido y jalapeños + papas a la francesa y papas gajo."
      },
      {
        "icon": "🌭",
        "text": "Hot dogs miniatura y corn dogs con mostaza, catsup y salsas artesanales."
      },
      {
        "icon": "🫙",
        "text": "BBQ ahumado, cheddar fundido, ranch, chipotle mayo, mustard honey y búfalo."
      },
      {
        "icon": "🍽️",
        "text": "Personal uniformado, montaje de barra completo y duración según el paquete."
      }
    ],
    "whyUs": [],
    "varieties": [],
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "🐷",
        "text": "Cerdo marinado en achiote, naranja agria y especias, cocinado en hoja de plátano."
      },
      {
        "icon": "🌮",
        "text": "Fritos al momento con frijol espelón, rellenos de cochinita o pollo con escabeche."
      },
      {
        "icon": "🧅",
        "text": "El acompañante inseparable: cebolla en vinagre de naranja agria y orégano yucateco."
      },
      {
        "icon": "🌶️",
        "text": "Salsa de habanero fresca, xcatic en escabeche y habanero asado. Para los valientes."
      },
      {
        "icon": "🍋",
        "text": "Aguas regionales del sureste: de jamaica, chaya con piña y horchata de coco."
      },
      {
        "icon": "🎭",
        "text": "Manteles bordados, servilletas de terno y flores de heliconias para ambientar."
      }
    ],
    "whyUs": [],
    "varieties": [],
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "🥩",
        "text": "Asado de tira, entraña, vacío, bife de chorizo y tira de costilla."
      },
      {
        "icon": "🌿",
        "text": "Preparado el mismo día con perejil, orégano, ajo, vinagre y ají molido."
      },
      {
        "icon": "🔥",
        "text": "Asador profesional con técnica argentina. El espectáculo es parte del servicio."
      },
      {
        "icon": "🥗",
        "text": "Jitomate, pimiento verde, cebolla, zanahoria y vinagreta de limón."
      },
      {
        "icon": "🥖",
        "text": "Pan rústico artesanal para acompañar la carne con chimichurri."
      },
      {
        "icon": "🍷",
        "text": "Opción de incluir servicio de vino Malbec argentino coordinado con la carne."
      }
    ],
    "whyUs": [],
    "varieties": [],
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "🥩",
        "text": "Arrachera de res marinada 12 horas en receta propia. Suave y jugosa al punto."
      },
      {
        "icon": "🦴",
        "text": "Costillas corte americano, en salsa BBQ ahumada preparada en casa."
      },
      {
        "icon": "🧅",
        "text": "Asadas directamente en la parrilla con aceite de oliva y sal gruesa."
      },
      {
        "icon": "🌶️",
        "text": "Chiles güeros y jalapeños asados. Complemento infaltable del asado mexicano."
      },
      {
        "icon": "🫙",
        "text": "Tres tipos: verde tomatillo, roja molcajeteada y habanero para valientes."
      },
      {
        "icon": "🌮",
        "text": "Tortillas calientes para hacer taquitos. El complemento perfecto."
      }
    ],
    "whyUs": [],
    "varieties": [],
  ...
  },
  {
    ...
    "description": [
      ...
      "Ofrecemos hasta 8 guisados diferentes servidos en cazuelas de barro, con tortillas hechas a mano en comal directamente en el evento. Cada taquero tiene experiencia en eventos de más de 200 personas, garantizando rapidez y calidad constante.\",'El concepto es sencillo y efectivo: comida que todos conocen y aman, preparada con ingredientes de primera calidad. Funciona perfectamente a cualquier hora: al mediodía como plato fuerte o a la medianoche como \"segunda cena\" para reactivar la fiesta.'"
    ],
    "related": [],
    "included": [
      {
        "icon": "🌮",
        "text": "Hasta 8 opciones rotando: tinga, rajas, chicharrón, frijoles, mole y más."
      },
      {
        "icon": "🫓",
        "text": "Tortillera en sitio con comal de barro. Tortillas calientes todo el tiempo."
      },
      {
        "icon": "🫙",
        "text": "Verde, roja, habanero, macha y pico de gallo. Preparadas en el lugar."
      },
      {
        "icon": "🧅",
        "text": "Cilantro, cebolla, nopales, aguacate, chicharrón prensado y crema."
      },
      {
        "icon": "👨‍🍳",
        "text": "Con comal, cazuelas de barro y uniforme. El toque auténtico del street food."
      },
      {
        "icon": "🍹",
        "text": "Jamaica o tamarindo preparados en olla grande. El complemento perfecto."
      }
    ],
    "whyUs": [],
    "varieties": [],
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "🥙",
        "text": "Hechas a mano en el momento con masa fresca. Rellenos a elección."
      },
      {
        "icon": "🌽",
        "text": "Tlacoyos de frijol, habas y requesón. Memelas de maíz azul y blanco."
      },
      {
        "icon": "🧀",
        "text": "Con flor de calabaza, huitlacoche, champiñones, chicharrón y queso Oaxaca."
      },
      {
        "icon": "🫙",
        "text": "Salsa verde, salsa roja, crema, queso, cebolla, cilantro y nopales."
      },
      {
        "icon": "🌮",
        "text": "Opción de incluir tamales de hoja de maíz: rajas, elote, dulce y mole."
      },
      {
        "icon": "☕",
        "text": "Para los eventos matutinos o nocturnos: atole de guayaba o champurrado."
      }
    ],
    "whyUs": [],
    "varieties": [],
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "🌽",
        "text": "Preparada con maíz nixtamalizado el mismo día. Sin harina ni conservadores."
      },
      {
        "icon": "🧀",
        "text": "Queso genuino de la región, importado directamente de Oaxaca."
      },
      {
        "icon": "🌸",
        "text": "Flor de calabaza y huitlacoche en temporada. El relleno más mexicano."
      },
      {
        "icon": "🍄",
        "text": "Portobellos, setas y champiñones salteados al ajo con epazote."
      },
      {
        "icon": "🫙",
        "text": "Verde, roja, pico de gallo y salsa de chile de árbol. Molcajeteadas."
      },
      {
        "icon": "🥑",
        "text": "Hecho al momento con aguacate Hass, cilantro, chile y limón."
      }
    ],
    "whyUs": [],
    "varieties": [],
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "🌽",
        "text": "Elote en vaso o mazorca con mayonesa, queso, chile y limón. Todos los acompañantes."
      },
      {
        "icon": "🍎",
        "text": "Sandía, mango, melón y pepino con chamoy, chile en polvo y limón."
      },
      {
        "icon": "🥒",
        "text": "Pepino y jícama en bastones con salsa valentina, limón y sal de gusano."
      },
      {
        "icon": "🍿",
        "text": "Mantequilla artesanal, caramelo, cheddar, trufa y chile piquín."
      },
      {
        "icon": "🫙",
        "text": "Chamoy, valentina, tajín, sal de gusano, mayonesa y limones. Todo incluido."
      },
      {
        "icon": "🎪",
        "text": "Carrito estilizado con iluminación y personalización del nombre del evento."
      }
    ],
    "whyUs": [],
    "varieties": [],
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "🍹",
        "text": "Servicio profesional con formación en coctelería clásica y mixología contemporánea."
      },
      {
        "icon": "🥃",
        "text": "Montaje de barra profesional con cristalería completa incluida."
      },
      {
        "icon": "🍷",
        "text": "Selección de vinos tintos, blancos, rosados y cava para los brindis."
      },
      {
        "icon": "🧊",
        "text": "Hielo en cubos, picado y en esfera. Servicio continuo durante todo el evento."
      },
      {
        "icon": "🧃",
        "text": "Margaritas sin alcohol, aguas frescas gourmet, café, té y jugos naturales."
      },
      {
        "icon": "🍸",
        "text": "Mezcal, gin, cócteles de autor y mixología especial según el estilo del evento."
      }
    ],
    "whyUs": [],
    "varieties": [],
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "🧃",
        "text": "Naranja, limón, maracuyá, tamarindo y sandía exprimidos en el momento."
      },
      {
        "icon": "🌿",
        "text": "Albahaca, menta, romero, jengibre y lavanda para aromatizar y decorar."
      },
      {
        "icon": "🫧",
        "text": "Agua mineral, tónica y agua de Jamaica para las bases espumantes."
      },
      {
        "icon": "🍓",
        "text": "Fresas, mango, maracuyá, guayaba, lichee y más. Según la temporada."
      },
      {
        "icon": "🧊",
        "text": "Cubos grandes y esferas de hielo claro para presentaciones premium."
      },
      {
        "icon": "🎨",
        "text": "Flores comestibles, rodajas deshidratadas, sal de colores y azúcar saborizada."
      }
    ],
    "whyUs": [],
    "varieties": [],
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "🎓",
        "text": "Con formación en escuelas internacionales de coctelería y experiencia comprobada."
      },
      {
        "icon": "🔥",
        "text": "Smoke, fat washing, sous vide, infusiones en frío y clarificación."
      },
      {
        "icon": "🌿",
        "text": "Mezcal, pulque, tepache, tamarindo, hibiscus y chiles para cócteles únicos."
      },
      {
        "icon": "📋",
        "text": "Diseñamos un menú exclusivo para tu evento, con nombre y historia de cada trago."
      },
      {
        "icon": "🎭",
        "text": "Preparación espectacular con fuego, humo, nitrógeno o flair según el paquete."
      },
      {
        "icon": "📸",
        "text": "Cócteles diseñados para la era de las redes sociales. Cada copa es una foto."
      }
    ],
    "whyUs": [],
    "varieties": [],
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "☕",
        "text": "Personal capacitado y certificado con experiencia en eventos de alto nivel."
      },
      {
        "icon": "🌱",
        "text": "Café tostado tipo italiano de origen seleccionado. Granos de la más alta calidad."
      },
      {
        "icon": "🥛",
        "text": "Espresso, latte, cappuccino, moka, matcha, chai, frappuccino, tés y chocolate."
      },
      {
        "icon": "🎨",
        "text": "Máquina espresso profesional, molino, vaporizador y todo el equipo necesario."
      },
      {
        "icon": "⏰",
        "text": "Bebidas preparadas al momento durante toda la duración del evento."
      },
      {
        "icon": "✨",
        "text": "Instalación y retiro del equipo incluidos. Sin preocupaciones para el organizador."
      }
    ],
    "whyUs": [],
    "varieties": [],
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "🧊",
        "text": "Paletas de agua y de leche en sabores clásicos, tropicales y gourmet."
      },
      {
        "icon": "🛒",
        "text": "Carrito vintage o moderno personalizado con el nombre de tu evento."
      },
      {
        "icon": "🌫️",
        "text": "Preparación dramática de helados al momento con nitrógeno líquido."
      },
      {
        "icon": "🎁",
        "text": "Empaque individual con el nombre del evento, fecha o logo. Detalle para llevar."
      },
      {
        "icon": "🌿",
        "text": "Sin colorantes artificiales. Solo frutas de temporada y sabores naturales."
      },
      {
        "icon": "🍦",
        "text": "Helado artesanal servido en cono o vasito como complemento."
      }
    ],
    "whyUs": [],
    "varieties": [],
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "🍭",
        "text": "Selección premium: chocolates, malvaviscos, caramelos, gomitas y dulces regionales."
      },
      {
        "icon": "🎨",
        "text": "Mesa diseñada a tu medida: colores, alturas, materiales y elementos decorativos."
      },
      {
        "icon": "🏺",
        "text": "Jarras de vidrio, fuentes, portarretratos y estructuras para exhibir los dulces."
      },
      {
        "icon": "🪧",
        "text": "Letrero con el nombre del evento, frase especial o logo. Incluido en todos los paquetes."
      },
      {
        "icon": "🎁",
        "text": "Bolsitas personalizadas para que los invitados lleven sus dulces favoritos."
      },
      {
        "icon": "👩‍🎨",
        "text": "Reunión previa para definir paleta de colores, temática y selección de dulces."
      }
    ],
    "whyUs": [],
    "varieties": [],
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "🎂",
        "text": "Pastel de pisos personalizado en sabores y decoración a elegir."
      },
      {
        "icon": "🍮",
        "text": "Mousse, panna cotta, tartaletas, éclairs, mini pavlovas y más."
      },
      {
        "icon": "🌸",
        "text": "Flores comestibles y no comestibles para decorar la mesa y los postres."
      },
      {
        "icon": "🏗️",
        "text": "Estructuras de metal, madera o acrílico para crear alturas y perspectiva."
      },
      {
        "icon": "🧁",
        "text": "Mínimo 3 sabores de macarons. El detalle más fotografiado de la mesa."
      },
      {
        "icon": "🍽️",
        "text": "Mini platos de porcelana y tenedores de postre para servirse."
      }
    ],
    "whyUs": [],
    "varieties": [],
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "🧀",
        "text": "Gruyere suizo, Manchego español, Gouda holandés, Camembert, Brie, Provolone, Queso de cabra, Oaxaca y 3 quesos premium de temporada."
      },
      {
        "icon": "🥩",
        "text": "Salami, chorizo español, jamón serrano, jamón de pierna y jamón de pavo en láminas finas."
      },
      {
        "icon": "🍯",
        "text": "Dulce de membrillo, uvas frescas, higos y mermeladas artesanales de temporada."
      },
      {
        "icon": "🥜",
        "text": "Nueces pecanas, almendras tostadas, pistaches y semillas variadas."
      },
      {
        "icon": "🍞",
        "text": "Baguette recién horneada, crackers de semillas, pan de oliva y pan de nuez."
      },
      {
        "icon": "📋",
        "text": "Tarjetas con nombre, origen, notas de sabor y maridaje sugerido para cada queso."
      }
    ],
    "whyUs": [],
    "varieties": [],
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "🧁",
        "text": "Harina de trigo de primera, mantequilla sin sal europea y huevos de rancho."
      },
      {
        "icon": "🎨",
        "text": "Diseño en fondant o buttercream replicando la temática del evento."
      },
      {
        "icon": "🌿",
        "text": "Vainilla de Tahití, chocolate belga 70%, limón siciliano, café y matcha."
      },
      {
        "icon": "🎁",
        "text": "Caja individual con cinta personalizada y tarjeta del evento."
      },
      {
        "icon": "🏗️",
        "text": "Estructura para presentar los cupcakes como alternativa visual al pastel."
      },
      {
        "icon": "🚫",
        "text": "Sin gluten, sin azúcar y veganos. Sin sacrificar sabor ni calidad."
      }
    ],
    "whyUs": [],
    "varieties": [],
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "🚚",
        "text": "Trasladamos el mobiliario al venue, lo armamos y lo retiramos al finalizar."
      },
      {
        "icon": "📐",
        "text": "Seguimos el plano de tu evento para configurar mesas y sillas perfectamente."
      },
      {
        "icon": "🧹",
        "text": "Todo el mobiliario llega limpio, sin polvo, sin manchas y en estado impecable."
      },
      {
        "icon": "🔧",
        "text": "Técnico disponible durante el evento para cualquier ajuste de último momento."
      },
      {
        "icon": "📦",
        "text": "Garantizamos el número exacto de piezas solicitadas. Sin sorpresas."
      },
      {
        "icon": "🤝",
        "text": "Coordinamos directamente con el salón o espacio para tiempos de montaje."
      }
    ],
    "whyUs": [],
    "varieties": [],
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "🛋️",
        "text": "Juego completo de sala con sofá de 3 plazas, 2 sillones y mesa de centro."
      },
      {
        "icon": "💡",
        "text": "Lámparas de pie y de mesa coordinadas para crear el ambiente correcto."
      },
      {
        "icon": "🪑",
        "text": "Mesas altas tipo bar con 2 o 4 taburetes según el modelo."
      },
      {
        "icon": "🎨",
        "text": "Múltiples opciones de color y acabado para coordinar con la decoración."
      },
      {
        "icon": "🚚",
        "text": "Trasladamos y armamos todo en el venue. Retiro al finalizar."
      },
      {
        "icon": "📐",
        "text": "Sugerimos la mejor disposición de salas y periqueras según tu espacio."
      }
    ],
    "whyUs": [],
    "varieties": [],
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "🔧",
        "text": "Equipo especializado en armado y desmontaje de pistas. Hasta 4 horas de armado."
      },
      {
        "icon": "📏",
        "text": "Modular desde 4x4m hasta 12x12m. Configuración adaptada a tu espacio."
      },
      {
        "icon": "💡",
        "text": "En los modelos LED: iluminación programable con miles de combinaciones."
      },
      {
        "icon": "🛡️",
        "text": "Bordes de seguridad en todos los modelos para evitar caídas."
      },
      {
        "icon": "🚚",
        "text": "Transporte al venue, instalación y retiro. Sin cargos adicionales."
      },
      {
        "icon": "🎛️",
        "text": "En modelos iluminados: controlador inalámbrico para cambiar efectos."
      }
    ],
    "whyUs": [],
    "varieties": [],
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "🍽️",
        "text": "Plato base, plato de presentación, hondo, tendido, postre y pan."
      },
      {
        "icon": "🥂",
        "text": "Copa de agua, de vino tinto, blanco y flauta de champagne."
      },
      {
        "icon": "🥄",
        "text": "Tenedor, cuchillo, cuchara, tenedor de postre y cucharita de café."
      },
      {
        "icon": "🧺",
        "text": "Servilleteros metálicos, charolas de servicio y porta-menús."
      },
      {
        "icon": "🫙",
        "text": "Juegos de sal y pimienta para cada mesa o sección."
      },
      {
        "icon": "🌹",
        "text": "Coordinamos directamente con tu proveedor de catering para el montaje."
      }
    ],
    "whyUs": [],
    "varieties": [],
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "💫",
        "text": "Propuesta visual adaptada a la temática, colores y espacio de tu evento."
      },
      {
        "icon": "🔧",
        "text": "Equipo especializado en trabajo en altura con arneses certificados."
      },
      {
        "icon": "💡",
        "text": "Muchos de nuestros colgantes incluyen iluminación LED integrada o guirnaldas."
      },
      {
        "icon": "🌸",
        "text": "Instalaciones florales suspendidas con flores naturales o artificiales premium."
      },
      {
        "icon": "🪡",
        "text": "Cortinas de gasa, tul, seda o terciopelo. Cada tejido crea un efecto diferente."
      },
      {
        "icon": "🚚",
        "text": "Llegamos con anticipación y retiramos todo al finalizar el evento."
      }
    ],
    "whyUs": [],
    "varieties": [],
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "✨",
        "text": "Cada silla revisada y pulida antes de entregarse. Sin rayaduras ni manchas."
      },
      {
        "icon": "🎨",
        "text": "Transparente, rosa, azul cielo, verde menta y dorado. Elige el tuyo."
      },
      {
        "icon": "💪",
        "text": "Resina de alta densidad. Soporta hasta 120kg sin deformarse."
      },
      {
        "icon": "🚚",
        "text": "Traslado al venue, posicionamiento y retiro al finalizar el evento."
      },
      {
        "icon": "🪑",
        "text": "Cojín tapizado en tela coordinada con la decoración, disponible por costo adicional."
      },
      {
        "icon": "📦",
        "text": "Comprometemos el número exacto de sillas desde el momento de la cotización."
      }
    ],
    "whyUs": [],
    "varieties": [],
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "🏭",
        "text": "Gestión integral: personal, inventario, menús, higiene y reportes mensuales."
      },
      {
        "icon": "👨‍⚕️",
        "text": "Nutriólogo en equipo para diseñar menús balanceados adaptados a tu fuerza laboral."
      },
      {
        "icon": "📊",
        "text": "Reportes de costo por ración, desperdicio y optimización mensual."
      },
      {
        "icon": "🧹",
        "text": "Protocolos HACCP implementados. Auditorías de higiene mensuales."
      },
      {
        "icon": "🔄",
        "text": "Menú con rotación semanal de 4 semanas para evitar la monotonía."
      },
      {
        "icon": "🚗",
        "text": "Servicio de viandas transportadas para oficinas sin comedor propio."
      }
    ],
    "whyUs": [],
    "varieties": [],
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "🏛️",
        "text": "+200 espacios aliados en CDMX, GDL, MTY, QRO y principales ciudades."
      },
      {
        "icon": "🗺️",
        "text": "Organizamos las visitas a los espacios y te acompañamos en el recorrido."
      },
      {
        "icon": "📋",
        "text": "Revisamos el contrato del venue para proteger tus intereses y fechas."
      },
      {
        "icon": "💰",
        "text": "Negociamos en tu nombre con los venues para obtener las mejores condiciones."
      },
      {
        "icon": "📅",
        "text": "Confirmamos disponibilidad y reservamos la fecha con anticipación."
      },
      {
        "icon": "🔧",
        "text": "Coordinamos todos los proveedores para el día de montaje en el venue."
      }
    ],
    "whyUs": [],
    "varieties": [],
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "🌸",
        "text": "Ramo de novia, ramos de damas, boutonnières y accesorios florales."
      },
      {
        "icon": "🌹",
        "text": "Desde el arreglo más sencillo hasta las creaciones más elaboradas."
      },
      {
        "icon": "🌿",
        "text": "Arco de flores para la ceremonia o foto call del evento."
      },
      {
        "icon": "💐",
        "text": "Entrada, pasillos, mesas de dulces, escaleras y todos los puntos del espacio."
      },
      {
        "icon": "🎁",
        "text": "Flores en las sillas, pétalos de rosa y detalles florales personalizados."
      },
      {
        "icon": "🎨",
        "text": "Reunión previa para definir paleta floral, estilo y presupuesto."
      }
    ],
    "whyUs": [
      {
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "📸",
        "text": "Dos fotógrafos en simultáneo para no perder ningún ángulo."
      },
      {
        "icon": "🎬",
        "text": "Video con edición cinematográfica, música seleccionada y color grading profesional."
      },
      {
        "icon": "🚁",
        "text": "Tomas aéreas del venue, la llegada de los invitados y los momentos especiales."
      },
      {
        "icon": "🖼️",
        "text": "Álbum en tapa dura con papel fotográfico de lujo y diseño editorial."
      },
      {
        "icon": "💻",
        "text": "Galería en línea con descarga ilimitada, compartible con todos los invitados."
      },
      {
        "icon": "⏱️",
        "text": "Galería preliminar en 2 semanas, entrega final completa en 6 semanas."
      }
    ],
    "whyUs": [
      {
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "🏰",
        "text": "Modelos de 3x3m hasta 6x6m. Para 10 a 30 niños simultáneamente."
      },
      {
        "icon": "💦",
        "text": "Para eventos de verano: tobogán de agua y alberca inflable de diversión."
      },
      {
        "icon": "⚡",
        "text": "Motor de 2HP instalado en el lugar. Sin costo adicional."
      },
      {
        "icon": "🛡️",
        "text": "PVC ignífugo y atóxico. Costuras reforzadas de doble hilera."
      },
      {
        "icon": "🧹",
        "text": "Cada inflable llega desinfectado y en perfectas condiciones."
      },
      {
        "icon": "📞",
        "text": "Técnico disponible vía telefónica durante toda la duración del evento."
      }
    ],
    "whyUs": [],
    "varieties": [],
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "🎧",
        "text": "Con experiencia en bodas, corporativos y fiestas de alto perfil."
      },
      {
        "icon": "🔊",
        "text": "Parlantes L-Acoustics o similar. Ideal para 50 a 1,000 personas."
      },
      {
        "icon": "💡",
        "text": "Leds, movers, láseres, máquina de humo y cañón de confetti."
      },
      {
        "icon": "🎤",
        "text": "Micrófonos inalámbricos incluidos. Opcional: conductor de la noche."
      },
      {
        "icon": "📋",
        "text": "Reunión previa para definir el repertorio, los momentos especiales y los temas prohibidos."
      },
      {
        "icon": "🎵",
        "text": "Todos los géneros, décadas y solitudes especiales de los invitados."
      }
    ],
    "whyUs": [
      {
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "🎂",
        "text": "Diseño exclusivo a discutir. Desde 1 hasta 5 pisos. Cualquier sabor."
      },
      {
        "icon": "🧁",
        "text": "En los colores del evento. Mínimo 5 sabores diferentes."
      },
      {
        "icon": "🍰",
        "text": "Bocados de repostería fina para complementar la mesa de postres."
      },
      {
        "icon": "🌸",
        "text": "Flores de azúcar, fondant y oblea. Arte en cada capa del pastel."
      },
      {
        "icon": "🚚",
        "text": "Transportamos y ensamblamos el pastel en el venue el día del evento."
      },
      {
        "icon": "🧾",
        "text": "Cita de degustación de sabores antes de confirmar el pedido final."
      }
    ],
    "whyUs": [
      {
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "🎭",
        "text": "Bailarines, magos, comediantes, acróbatas y shows temáticos."
      },
      {
        "icon": "🎵",
        "text": "Coordinamos con el DJ o la banda para el acompañamiento musical del show."
      },
      {
        "icon": "💡",
        "text": "Focos especiales para el show coordinados con el equipo de luz del evento."
      },
      {
        "icon": "📋",
        "text": "Reunión previa para definir el timing, el espacio y los momentos especiales."
      },
      {
        "icon": "🎪",
        "text": "Los artistas incluyen vestuario y accesorios propios del show."
      },
      {
        "icon": "🔄",
        "text": "Siempre tenemos un artista de respaldo por cualquier contingencia."
      }
    ],
    "whyUs": [],
    "varieties": [],
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "👰",
        "text": "Mínimo 8 reuniones durante la planeación para revisar avances y tomar decisiones."
      },
      {
        "icon": "📋",
        "text": "Seleccionamos, cotizamos, negociamos y coordinamos todos los proveedores."
      },
      {
        "icon": "💰",
        "text": "Hoja de control mensual para que sepas en tiempo real en qué y cuánto vas."
      },
      {
        "icon": "📅",
        "text": "Minuto a minuto del día de la boda, compartido con todos los proveedores."
      },
      {
        "icon": "📞",
        "text": "Planner presente 12 horas. Se encarga de TODO para que tú solo disfrutes."
      },
      {
        "icon": "🎨",
        "text": "Moodboard, paleta de colores y concepto visual de la boda. Todo en coherencia."
      }
    ],
    "whyUs": [
      {
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "🍽️",
        "text": "Desde el aperitivo de bienvenida hasta la cena completa y el pastel."
      },
      {
        "icon": "💐",
        "text": "Ramos, centros de mesa, arco floral y decoración completa del venue."
      },
      {
        "icon": "📸",
        "text": "Cobertura completa con galería digital, álbum y video cinematográfico."
      },
      {
        "icon": "🎵",
        "text": "Desde el vals hasta el cierre de la fiesta. DJ o banda en vivo."
      },
      {
        "icon": "🪑",
        "text": "Sillas de diseño, mesas, pistas de baile, salas lounge y más."
      },
      {
        "icon": "👰",
        "text": "Coordinación completa o solo el día. Tú decides cuánto apoyo necesitas."
      }
    ],
    "whyUs": [],
    "varieties": [],
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "🎂",
        "text": "Diseñado a medida en los colores y temática elegidos."
      },
      {
        "icon": "🍽️",
        "text": "Cena completa con servicio de meseros y presentación impecable."
      },
      {
        "icon": "💐",
        "text": "Arreglo completo del salón: mesa principal, centros de mesa y entrada."
      },
      {
        "icon": "🎵",
        "text": "DJ con repertorio para el vals y la fiesta, coordinando cada momento especial."
      },
      {
        "icon": "🍭",
        "text": "Diseñada en los colores del evento con los dulces favoritos de la quinceañera."
      },
      {
        "icon": "📸",
        "text": "Cobertura del día completo: misa, llegada, vals y fiesta."
      }
    ],
    "whyUs": [],
    "varieties": [],
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "☕",
        "text": "Pausas con café de especialidad y bocadillos gourmet para cualquier junta."
      },
      {
        "icon": "🍽️",
        "text": "Comidas de trabajo, cenas de gala y buffets para eventos de empresa."
      },
      {
        "icon": "🎵",
        "text": "DJ, músicos, shows y animadores para eventos de integración y premiaciones."
      },
      {
        "icon": "📸",
        "text": "Fotógrafo corporativo para comunicación interna y redes sociales."
      },
      {
        "icon": "🪑",
        "text": "Mesas, sillas, periqueras y lounge para cualquier formato de evento."
      },
      {
        "icon": "💐",
        "text": "Decoración con identidad de marca, señalética y elementos de branding."
      }
    ],
    "whyUs": [],
    "varieties": [],
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "🎀",
        "text": "Globos, flores, letreros, centros de mesa y decoración del área de apertura de regalos."
      },
      {
        "icon": "🍰",
        "text": "Diseñado con el nombre y la temática del bebé."
      },
      {
        "icon": "🍭",
        "text": "Diseñada en los colores elegidos con dulces personalizados."
      },
      {
        "icon": "🥐",
        "text": "Sándwiches, quiches, ensaladas, fruta y bebidas para la tarde."
      },
      {
        "icon": "📸",
        "text": "Cobertura del evento y sesión de fotos con props para mamá."
      },
      {
        "icon": "🎁",
        "text": "Souvenirs personalizados para que cada invitada lleve un recuerdo."
      }
    ],
    "whyUs": [],
    "varieties": [],
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "🎂",
        "text": "Pastel diseñado para el festejado: sabor favorito y decoración a medida."
      },
      {
        "icon": "🍽️",
        "text": "Desde tacos y taquizas hasta buffet gourmet. Cualquier estilo, cualquier edad."
      },
      {
        "icon": "🎵",
        "text": "DJ, mariachi, banda, o los shows que sean ideales para la edad del festejado."
      },
      {
        "icon": "💐",
        "text": "Globos, flores, letreros y centros de mesa coordinados con la temática."
      },
      {
        "icon": "📸",
        "text": "Cobertura del evento con sesión de fotos y galería digital."
      },
      {
        "icon": "🎁",
        "text": "Bolsitas de recuerdo personalizadas con el nombre y fecha del evento."
      }
    ],
    "whyUs": [],
    "varieties": [],
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "👶",
        "text": "Proporciones adaptadas para niños de 3 a 12 años aproximadamente."
      },
      {
        "icon": "🎨",
        "text": "Mismo estilo Tiffany que el resto del mobiliario del evento."
      },
      {
        "icon": "✅",
        "text": "Revisada y limpia. Sin bordes afilados ni daños."
      },
      {
        "icon": "🚚",
        "text": "Coordinamos la entrega junto con el resto del mobiliario."
      }
    ],
    "whyUs": [],
    "varieties": [],
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "✨",
        "text": "Acrílico transparente que no interrumpe la línea visual del espacio."
      },
      {
        "icon": "📸",
        "text": "Ideal para eventos donde la fotografía es importante."
      },
      {
        "icon": "✅",
        "text": "Cada unidad revisada para garantizar perfecta transparencia."
      },
      {
        "icon": "🚚",
        "text": "Transportamos con cuidado para evitar rayones."
      }
    ],
    "whyUs": [],
    "varieties": [],
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "🎨",
        "text": "Negro, rosa y beige. Para eventos modernos y románticos."
      },
      {
        "icon": "🛋️",
        "text": "Diseño ergonómico que garantiza confort en eventos largos."
      },
      {
        "icon": "✅",
        "text": "Revisada y limpia para cada evento."
      },
      {
        "icon": "🚚",
        "text": "Instalamos en el venue acordado."
      }
    ],
    "whyUs": [],
    "varieties": [],
  ...
  },
  {
    ...
    "description": [
      ...
      "Disponible en negro y blanco, la Silla Camila es perfecta para eventos que buscan una estética limpia y moderna. El negro aporta sofisticación a galas corporativas; el blanco, pureza y luminosidad a bodas y ceremonias.\",'Con disponibilidad de hasta 300 unidades, podemos atender eventos de cualquier tamaño. La Silla Camila también es protagonista en los famosos conjuntos \"Mesa Black Shine & Silla Camila\" para eventos de altísimo impacto visual.'"
    ],
    "related": [],
    "included": [
      {
        "icon": "🎨",
        "text": "Negro y blanco. Clásica bitonalidad para eventos contemporáneos."
      },
      {
        "icon": "🛋️",
        "text": "Tapizado cómodo que garantiza confort durante todo el evento."
      },
      {
        "icon": "✅",
        "text": "Revisada y limpia. Tapizado sin manchas."
      },
      {
        "icon": "🔢",
        "text": "Hasta 300 unidades para eventos grandes."
      }
    ],
    "whyUs": [],
    "varieties": [],
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "🎨",
        "text": "Arena, nude y gris. Perfectos para paletas neutras y naturales."
      },
      {
        "icon": "🌿",
        "text": "Textura de canasta que complementa decoraciones naturales y boho."
      },
      {
        "icon": "✅",
        "text": "Revisada y limpia antes de cada entrega."
      },
      {
        "icon": "🚚",
        "text": "Instalamos en el venue acordado."
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "🎨",
        "text": "Nude, negra y rosa. Versatilidad para cualquier tipo de evento."
      },
      {
        "icon": "🛋️",
        "text": "Asiento tapizado que garantiza confort durante todo el evento."
      },
      {
        "icon": "✅",
        "text": "Tapizado sin manchas, revisado antes de cada entrega."
      },
      {
        "icon": "🔢",
        "text": "Hasta 100 unidades por color."
      }
    ],
    "whyUs": [],
    "varieties": [],
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "🎨",
        "text": "Beige y negro. Contraste elegante de metal y tapizado."
      },
      {
        "icon": "🔩",
        "text": "Base de metal negro resistente y de larga durabilidad."
      },
      {
        "icon": "✅",
        "text": "Revisada y limpia. Sin rayones en la estructura."
      },
      {
        "icon": "🚚",
        "text": "Instalamos en el venue acordado."
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "🎨",
        "text": "Negro elegante, minimalista y versátil."
      },
      {
        "icon": "🏛️",
        "text": "Silueta única con forma distintiva y respaldo geométrico."
      },
      {
        "icon": "✅",
        "text": "Revisada y limpia antes de cada entrega."
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "🎨",
        "text": "Negro elegante y atemporal para cualquier tipo de evento."
      },
      {
        "icon": "🔩",
        "text": "Estructura firme que garantiza estabilidad y durabilidad."
      },
      {
        "icon": "✅",
        "text": "Revisada y limpia antes de cada entrega."
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "🔩",
        "text": "Estructura metálica de alta durabilidad, ideal para exteriores."
      },
      {
        "icon": "🏛️",
        "text": "El clásico industrial reconocido a nivel mundial."
      },
      {
        "icon": "✅",
        "text": "Revisada y sin óxido ni daños antes de cada evento."
      },
      {
        "icon": "🚚",
        "text": "Instalamos en el venue acordado."
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "💰",
        "text": "$70 por unidad. La mejor relación calidad-precio de la colección."
      },
      {
        "icon": "🔢",
        "text": "Hasta 500 unidades para eventos de cualquier escala."
      },
      {
        "icon": "✅",
        "text": "Revisada y limpia antes de cada entrega."
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "🎨",
        "text": "Caoba y natural. Calidez de madera para eventos con personalidad."
      },
      {
        "icon": "🔢",
        "text": "Hasta 800 unidades en caoba y 500 en natural."
      },
      {
        "icon": "✅",
        "text": "Revisada y limpia antes de cada entrega."
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "🏛️",
        "text": "Ícono del diseño escandinavo del siglo XX."
      },
      {
        "icon": "🎨",
        "text": "Cuerda trenzada artesanalmente que aporta textura y calidez."
      },
      {
        "icon": "✅",
        "text": "Revisada y sin daños en el tejido antes de cada evento."
      },
      {
        "icon": "🚚",
        "text": "Instalamos con cuidado en el venue acordado."
      }
    ],
    "whyUs": [],
    "varieties": [],
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "👑",
        "text": "Patas torneadas y respaldo ornamentado estilo corte francesa."
      },
      {
        "icon": "🎨",
        "text": "Beige elegante que complementa cualquier paleta de evento de lujo."
      },
      {
        "icon": "✅",
        "text": "Tapizado sin manchas, estructura sin daños."
      },
      {
        "icon": "🔢",
        "text": "Hasta 100 unidades para eventos de lujo."
      }
    ],
    "whyUs": [],
    "varieties": [],
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "🎨",
        "text": "Negro, natural y caoba. Tres personalidades en un solo modelo."
      },
      {
        "icon": "🔢",
        "text": "Hasta 200 unidades para eventos de gran escala."
      },
      {
        "icon": "✅",
        "text": "Revisada y limpia antes de cada entrega."
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "👑",
        "text": "Más grande y ornamentado para destacar a los novios visualmente."
      },
      {
        "icon": "🛋️",
        "text": "Tapizado de alta calidad para horas de uso sin incomodidad."
      },
      {
        "icon": "✅",
        "text": "Revisado minuciosamente antes de cada entrega."
      },
      {
        "icon": "🚚",
        "text": "Instalamos en la posición acordada de la mesa principal."
      }
    ],
    "whyUs": [],
    "varieties": [],
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "🎨",
        "text": "Arena cálido. Armoniza con paletas naturales y terrosas."
      },
      {
        "icon": "🛋️",
        "text": "Respaldo ergonómico para eventos de larga duración."
      },
      {
        "icon": "✅",
        "text": "Revisada y limpia antes de cada entrega."
  ...
  },
  {
    ...
    "related": [
      ...
      "/mesas/picnic",
      "Tablón Infantil",
      "/mesas/tablon-infantil"
    ],
    "included": [
      {
        "icon": "🪑",
        "text": "Caoba natural y mármol blanco. Perfectas para cualquier tema decorativo."
      },
      {
        "icon": "👥",
        "text": "8 a 10 personas por mesa. Ideal para bodas y banquetes."
      },
      {
        "icon": "🚚",
        "text": "Transportamos y montamos las mesas en el venue acordado."
      },
      {
        "icon": "📋",
        "text": "Pregúntanos por opciones de manteles coordinados."
      }
    ],
    "whyUs": [],
    "varieties": [],
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "🎨",
        "text": "Black Trendy, Caoba, Mármol Negro, Mármol Blanco y Vintage."
      },
      {
        "icon": "🔀",
        "text": "Se pueden unir para crear tablones largos o mesas en U."
      },
      {
        "icon": "🚚",
        "text": "Montamos y desmontamos las mesas en tu venue."
      },
      {
        "icon": "✅",
        "text": "Revisadas y limpias antes de cada entrega."
      }
    ],
    "whyUs": [],
    "varieties": [],
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "🎨",
        "text": "Caoba, Mármol Blanco, Mármol Negro, Vintage y edición Novios."
      },
      {
        "icon": "👥",
        "text": "10 a 20 personas por tablón según la configuración."
      },
      {
        "icon": "🌿",
        "text": "Perfectos para jardines, haciendas y bodas campestres."
      },
      {
        "icon": "🚚",
        "text": "Montamos y colocamos los tablones en el venue."
      }
    ],
    "whyUs": [],
    "varieties": [],
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "✨",
        "text": "Forma sinuosa que crea el WOW factor en cualquier evento."
      },
      {
        "icon": "🎨",
        "text": "Admite mantelería, florería y montajes creativos."
      },
      {
        "icon": "🚚",
        "text": "Montaje completo en tu venue con nuestro equipo."
      },
      {
        "icon": "📋",
        "text": "Te orientamos sobre la mejor configuración para tu espacio."
      }
    ],
    "whyUs": [],
    "varieties": [],
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "🌿",
        "text": "Diseñada para eventos en jardín, parque o terraza."
      },
      {
        "icon": "👶",
        "text": "Segura y cómoda para los más pequeños del evento."
      },
      {
        "icon": "🚚",
        "text": "Llevamos y colocamos las mesas en tu locación."
      },
      {
        "icon": "🎨",
        "text": "Combina con cualquier estilo de decoración casual o boho."
      }
    ],
    "whyUs": [],
    "varieties": [],
  ...
  },
  {
    ...
    "included": [
      {
        "icon": "👶",
        "text": "Diseñado para niños. Cómodo y seguro para los más pequeños."
      },
      {
        "icon": "🪑",
        "text": "Perfecto con Sillas Tiffany Infantiles para un conjunto completo."
      },
      {
        "icon": "🎨",
        "text": "Admite mantelería y decoración temática para la zona infantil."
      },
      {
        "icon": "🚚",
        "text": "Montamos la zona infantil completa en tu venue."
      }
    ],
    "whyUs": [],
    "varieties": [],
...
// Default empty product to prevent crashes on missing fields
const DEFAULT_PRODUCT = {
  slug: '',
  title: '',
  headline: '',
  seoTitle: 'Bodasesor Eventos',
  seoDescription: '',
  category: 'servicios',
  categoryLabel: 'Servicios',
  categoryHref: '/',
