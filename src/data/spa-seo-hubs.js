...
export const SPA_SEO_HUBS = [
  ...
  { path: '/cenas', title: 'Cenas', desc: 'Catering para cenas privadas, cenas de empresa y cenas de gala en México.' },
  { path: '/comidas', title: 'Comidas', desc: 'Catering para comidas familiares, almuerzos de trabajo y celebraciones de mediodía.' },
  { path: '/desayunos', title: 'Desayunos', desc: 'Catering para desayunos empresariales, brunch de bodas y reuniones matutinas.' },
  { path: '/lanzamientos', title: 'Lanzamientos', desc: 'Catering y organización para lanzamientos de producto, presentaciones de marca y ruedas de prensa.' },
  ...
  { path: '/comida-corrida', title: 'Comida Corrida', desc: 'Comida corrida y menú del día para comedores, empresas y eventos en México.' },
  { path: '/coffee-break', title: 'Coffee Break', desc: 'Coffee break con café de especialidad, pastelería y snacks para corporativos en México.' },
  ...
  { path: '/canapes-premium', title: 'Canapés Premium', desc: 'Canapés de autor para bodas y eventos de lujo en México.' },
  { path: '/desayuno-social', title: 'Desayuno Social', desc: 'Brunch y desayunos sociales para eventos matutinos y corporativos en México.' },
  // Barras de alimentos
  { path: '/barra-crepas', title: 'Barra de Crepas', desc: 'Barra de crepas dulces y saladas preparadas al momento para bodas y eventos.' },
  { path: '/barra-sushi', title: 'Barra de Sushi', desc: 'Barra de sushi y poke bowl con chef japonés para bodas y eventos en México.' },
  { path: '/barra-mariscos', title: 'Barra de Mariscos', desc: 'Barra de mariscos frescos: ceviche, ostiones y cocteles para eventos.' },
  { path: '/barra-paninis', title: 'Barra de Paninis', desc: 'Barra de paninis artesanales para bodas, XV años y eventos corporativos.' },
  { path: '/barra-pastas', title: 'Barra de Pastas', desc: 'Barra de pastas italianas preparadas al momento para bodas y eventos.' },
  { path: '/barra-pizzas', title: 'Barra de Pizzas', desc: 'Barra de pizzas artesanales al horno para fiestas y eventos en México.' },
  { path: '/barra-americana', title: 'Barra Americana', desc: 'Barra americana con hamburguesas, hot dogs y papas para eventos y fiestas.' },
  { path: '/barra-yucateca', title: 'Barra Yucateca', desc: 'Barra yucateca con cochinita pibil, salbutes y panuchos para eventos.' },
  // Estaciones
  { path: '/parrillada-argentina', title: 'Parrillada Argentina', desc: 'Parrillada argentina con cortes premium a la parrilla para bodas y eventos.' },
  { path: '/parrillada-tradicional', title: 'Parrillada Tradicional', desc: 'Parrillada tradicional mexicana para reuniones familiares y eventos.' },
  { path: '/taquiza-guisados', title: 'Taquiza de Guisados', desc: 'Taquiza de guisados auténticos para bodas, XV años y eventos en México.' },
  { path: '/puestos-antojitos', title: 'Puestos de Antojitos', desc: 'Puestos de antojitos mexicanos: tacos, sopes y gorditas para eventos.' },
  { path: '/puestos-quesadillas', title: 'Puestos de Quesadillas', desc: 'Puestos de quesadillas de tortilla azul o blanca para bodas y fiestas.' },
